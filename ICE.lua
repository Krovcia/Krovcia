...
wait(1)
VirtualInputManager:SendMouseButtonEvent(300, 155, 0, true, game, 1)
VirtualInputManager:SendMouseMoveEvent(300, 800, game)
wait(1)
VirtualInputManager:SendMouseButtonEvent(300, 155, 0, false, game, 1)
