...
if buahbuah == "Falcon" or buahbuah == "Dough" or buahbuah == "Lightning" or buahbuah == "Leopard" or buahbuah == "Ope" or buahbuah == "Venom" or buahbuah == "Nika" or buahbuah == "DragonV2" or buahbuah == "IceV2" or buahbuah == "MagmaV2" or buahbuah == "TSRubber" or buahbuah == "Soul" or buahbuah == "Dragon" or buahbuah == "DarkXQuake" then
